...
export default function Filter() {
  ...
  return (
    ...
    <div id="year-options" onClick={handleYearChange}>
      <div
        className={
          selectedYear === 2018 ? "active-option" : "filter-option"
        }
        id="2018"
      >
        2018
      ...
      <div
        className={
          selectedYear === 2019 ? "active-option" : "filter-option"
        }
        id="2019"
      >
        2019
      ...
      <div
        className={
          selectedYear === 2020 ? "active-option" : "filter-option"
        }
        id="2020"
      >
        2020
        ...
        <div className="col-md-4 mb-4">
          <div className="card h-100 card-body">
            <div className="car-item" key={index}>
              ...
              <div className="car-year mb-4">{`Year: ${item.release_year}`}</div>
              <img
